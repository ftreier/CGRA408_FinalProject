...
#
if [ -d /local/tmp/treierflor/$JOB_ID ]; then
        cd /local/tmp/treierflor/$JOB_ID
else
...
#
cp /vol/grid-solar/sgeusers/treierflor/test.jpg .
...
#
/usr/pkg/bin/convert test.jpg test.png
#
...
cp test.png  /vol/grid-solar/sgeusers/treierflor/$JOB_ID
#
echo "Ran through OK"
